...
export function StatsPage() {
  ...
  const topExercises = [...volumeByExercise.entries()].sort((a, b) => b[1] - a[1]).slice(0, 5);

  const bestRecords = [...maxWeightByExercise.entries()].sort((a, b) => b[1] - a[1]).slice(0, 5);
